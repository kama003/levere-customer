...
<body>
<?php
    $connect = mysqli_connect('localhost','levere','levere@001','levere') or die();
    if (isset($_GET['id'])) {
    $id = $_GET['id'];
  ...
  new THREE.GLTFLoader(loadingManager).load("../house/allDoorsModel/scene.glb", function(object) {
    ...
    model.traverse((n) => {
      if (n.isMesh) {
        ...
        model.getObjectByName('grass').material = grass_texture;
      ...
      model.getObjectByName("front_door_base1").position.z = <?php echo $row['FrontDoorPosition1'] ?>;
      model.getObjectByName("front_door_base2").position.z = <?php echo $row['FrontDoorPosition2'] ?>;
      model.getObjectByName("front_door_base3").position.z = <?php echo $row['FrontDoorPosition3'] ?>;
      model.getObjectByName("front_door_base4").position.z = <?php echo $row['FrontDoorPosition4'] ?>;
      ...
      model.getObjectByName("right_door_base1").position.x = <?php echo $row['RightDoorPosition1'] ?> / -1;
      model.getObjectByName("right_door_base2").position.x = <?php echo $row['RightDoorPosition2'] ?> / -1;
      model.getObjectByName("right_door_base3").position.x = <?php echo $row['RightDoorPosition3'] ?> / -1;
      model.getObjectByName("right_door_base4").position.x = <?php echo $row['RightDoorPosition4'] ?> / -1;
