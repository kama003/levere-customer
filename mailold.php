...
console.log($_POST);
    ...
    $worksheet->getCell('B21')->setValue($hps_coating);
    $worksheet->getCell('B22')->setValue($dakgoten);
    $worksheet->getCell('B23')->setValue($dakgoten_zijde);
    $worksheet->getCell('B24')->setValue($dakgoten_goten);
    $worksheet->getCell('B25')->setValue($sectionaaldeur);

    $worksheet->getCell('B26')->setValue($idee);
    $worksheet->getCell('B27')->setValue($heb);
    $worksheet->getCell('B28')->setValue($zonder);
    $worksheet->getCell('B29')->setValue($aanvraag);
    $worksheet->getCell('B30')->setValue($vraag);
    ...
    $worksheet->getCell('B46')->setValue($frontSectionalDoor1is);
    $worksheet->getCell('B47')->setValue($frontSectionalDoor2is);
    $worksheet->getCell('B48')->setValue($frontSectionalDoor3is);
    $worksheet->getCell('B49')->setValue($frontSectionalDoor4is);
    $worksheet->getCell('B50')->setValue($BackSectionalDoor1is);
    $worksheet->getCell('B51')->setValue($BackSectionalDoor2is);
    $worksheet->getCell('B52')->setValue($BackSectionalDoor3is);
    $worksheet->getCell('B53')->setValue($BackSectionalDoor4is);
    $worksheet->getCell('B54')->setValue($leftSectionalDoor1is);
    $worksheet->getCell('B55')->setValue($leftSectionalDoor2is);
    $worksheet->getCell('B56')->setValue($leftSectionalDoor3is);
    $worksheet->getCell('B57')->setValue($leftSectionalDoor4is);
    $worksheet->getCell('B58')->setValue($rightSectionalDoor1is);
    $worksheet->getCell('B59')->setValue($rightSectionalDoor1is);
    $worksheet->getCell('B60')->setValue($rightSectionalDoor1is);
    $worksheet->getCell('B61')->setValue($rightSectionalDoor1is);
    ...
    $worksheet->getCell('B67')->setValue($frontWalkingDoor1is);
    $worksheet->getCell('B68')->setValue($frontWalkingDoor2is);
    $worksheet->getCell('B69')->setValue($frontWalkingDoor3is);
    $worksheet->getCell('B70')->setValue($frontWalkingDoor4is);
    $worksheet->getCell('B71')->setValue($BackWalkingDoor1is);
    $worksheet->getCell('B72')->setValue($BackWalkingDoor2is);
    $worksheet->getCell('B73')->setValue($BackWalkingDoor3is);
    $worksheet->getCell('B74')->setValue($BackWalkingDoor4is);
    $worksheet->getCell('B75')->setValue($leftWalkingDoor1is);
    $worksheet->getCell('B76')->setValue($leftWalkingDoor2is);
    $worksheet->getCell('B77')->setValue($leftWalkingDoor3is);
    $worksheet->getCell('B78')->setValue($leftWalkingDoor4is);
    $worksheet->getCell('B79')->setValue($rightWalkingDoor1is);
    $worksheet->getCell('B80')->setValue($rightWalkingDoor2is);
    $worksheet->getCell('B81')->setValue($rightWalkingDoor3is);
    $worksheet->getCell('B82')->setValue($rightWalkingDoor4is);
...
if ($connect->query($query) === TRUE) {
  ...
  try {
      // Server settings
       ...
       $mail->Port = 587; 
       $mail->SMTPSecure = 'tls';
      $mail->Username = 'salimkhanoffice@gmail.com'; // YOUR email
      $mail->Password = 's9877223832'; // YOUR password

      // Sender and recipient settings
      $mail->setFrom('salimkhanoffice@gmail.com', 'Levere PVT LTD.');
      $mail->addAddress('salimkhanoffice@gmail.com', $name);
      $mail->addAddress('salimkhanoffice@gmail.com', $name);
          ...
          <main style="height: auto;width:100%;background:white;box-sizing: border-box;clear: both;">
              ...
              <div
                  ...
                  <div style="width: 47%;box-sizing: border-box;margin: 5px;float: left; background: #02723b;">
                      ...
                      <div
                          ...
                          <a href="https://levere.nl/3dloods/uploads/'.$randStr.'.xlsx"
                              style="position: relative !important;width: 100% !important;height: 70px !important;  background: #3c5b81 !important;display: flex !important; justify-content: center !important;align-items: center !important;text-align: center !important;text-decoration: none !important;list-style: none !important;">
                              <sapn style="color: white !important;font-size: 18px !important;font-weight : 600 !important;font-family: sans-serif !important;">
                  ...
                  <div style="width: 47%;box-sizing: border-box;margin: 5px;float: right; background: #ef6c4e;">
                      <!--tips: add .text-center,.text-right to the .card to change card text alignment-->
                      <img src="https://supremeanimation.com/levere/emailer/vandevelde_3D.png"
